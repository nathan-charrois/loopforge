...
export function selectFirstSelectedPattern(
  editor: Editor,
  workspace: Workspace,
): Pattern | undefined {
  if (editor.selection.selectedPatternIds.length === 1) {
    return selectPattern(workspace, editor.selection.selectedPatternIds[0])
  }
